...
// const uri = "mongodb+srv://assingment-10-by-saikat:EYGZgBmjUfntVrPH@cluster0.s64u1mi.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  ...
  const result = await wishCollection.updateOne(query,updatedProducts,options)
  res.send(result)
})
